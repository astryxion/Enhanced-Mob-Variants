...
public class Config {
    ...
    public static void load(File configDir) {
        ...
        spawnModeProp = commonCfg.get(
            ...
            new String[] { SpawnMode.RANDOM.name(), SpawnMode.UNIFORM.name() }
        );

        chicken = chickenProp.getBoolean();
        cow = cowProp.getBoolean();
        cat = catProp.getBoolean();
        pig = pigProp.getBoolean();
        sheep = sheepProp.getBoolean();
        wolf = wolfProp.getBoolean();
        zombie = zombieProp.getBoolean();
        skeleton = skeletonProp.getBoolean();
        spider = spiderProp.getBoolean();
