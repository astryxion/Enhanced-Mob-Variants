...
public class EventHandler {
    ...
    public static void onEntitySpawn(EntityJoinLevelEvent event) {
        if (event.getEntity() instanceof Chicken e && !e.isBaby() && !e.hasData(Registration.CHICKEN_VARIANT)) {
            e.setData(Registration.CHICKEN_VARIANT, e.getRandom().nextInt(8));
        }
        if (event.getEntity() instanceof Cow e && !e.isBaby() && !e.hasData(Registration.COW_VARIANT)) {
            e.setData(Registration.COW_VARIANT, e.getRandom().nextInt(10));
        }
        if (event.getEntity() instanceof Cat e && !e.isBaby() && !e.hasData(Registration.CAT_VARIANT)) {
            e.setData(Registration.CAT_VARIANT, e.getRandom().nextInt(6));
        }
        if (event.getEntity() instanceof Pig e && !e.isBaby() && !e.hasData(Registration.PIG_VARIANT)) {
        ...
        if (event.getEntity() instanceof Zombie e && !(e instanceof Husk) && !e.isBaby() && !e.hasData(Registration.ZOMBIE_VARIANT)) {
        ...
        if (event.getEntity() instanceof Sheep e && !e.isBaby() && !e.hasData(Registration.SHEEP_VARIANT)) {
        ...
        if (event.getEntity() instanceof Wolf e && !e.isBaby() && !e.hasData(Registration.WOLF_VARIANT)) {
